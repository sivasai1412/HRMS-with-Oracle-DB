...
/**
*This class is used to implements the web services for the indian public holidays.
*/
public class WebSample{
	
	/**
	*This method is used to return the name of the holiday for the particular date.
	*@param dateOfJoin This parameter is the date of joining of the employee.
	*@return holiday This method will return the name of the holiday.
	*@ParseException This exception is a checked exception an it can occur when you fail to parse a String that is ought to have a special format.
